							...
							<tbody>
								<?php foreach($mensalistas as $mensalista): ?>
									<tr>
										...
										<td><?php echo ($mensalista->mensalista_ativo?'<span class="badge badge-pill badge-success mb-1"><i class="fas fa-lock-open"></i> Sim</span>' : '<span class="badge badge-pill badge-warning mb-1"><i class="fas fa-lock"></i> Não</span>'); ?></td>
										<td class="text-right">
											...
											<button  type="button" title="Excluir <?php echo $this->router->fetch_class();?>" class="btn btn-icon btn-danger"  data-toggle="modal" data-target="#mensalista-<?php echo $mensalista->mensalista_id ?>"><i class="ik ik-trash-2"></i></button> 

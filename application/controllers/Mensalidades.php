...
class Mensalidades extends CI_Controller{
        ...
        if(!$mensalidade_id){
            ...
            if($this->form_validation->run()){
                ...
                $data = array(
                    ...
                    'icone_view' => 'fas fa-hand-holding-usd',
                    'texto_modal' => 'Os dados estão corretos? </br></br>Depois que salvar só será possível alterar a "Categoria" e a "Situação"',
                    'styles' => array(
    ...
    public function check_existe_mensalidade($mensalidade_data_vencimento) {
        ...
        /* Verifica no banco se há mensalidade já cadastrada para o mensalista e com a data passados no post */
    ...
    public function del($mensalidade_id = null){
        ...
        if(!$this->ion_auth->is_admin()){
            $this->session->set_flashdata('info', 'Você não tem permissão para excluir Mensalidades');
            redirect('/');
        }
